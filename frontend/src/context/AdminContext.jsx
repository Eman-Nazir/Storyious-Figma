  ...
  const getFAQs = async () => {
    try {
      ...
      if (res.data.data && Array.isArray(res.data.data)) {
        ...
        console.error("Unexpected FAQs response structure:", res.data);
        return [];
      }
    } catch (err) {
...
const getSubscribers = async () => {
  try {
    const res = await axios.get("http://localhost:8000/api/newsletter", {
      withCredentials: true,
    });

    console.log("Subscribers API response:", res.data);
    ...
    if (Array.isArray(res.data)) {
      ...
      console.error("Unexpected subscribers response structure:", res.data);
      return [];
    }
  } catch (err) {
...
const getAds = async () => {
  try {
    ...
    console.log("Ads API response:", res.data);
    ...
    if (Array.isArray(res.data)) {
      ...
      console.error("Unexpected ads response structure:", res.data);
      return [];
    }
  } catch (err) {
