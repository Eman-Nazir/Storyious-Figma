...
//           <Route path="/MoralStory-Detailed" element={<MoralStoryDetailedPage />} />
//           <Route path="/ClassicStory-Detailed" element={<ClassicStoryDetailedPage />} />
//           <Route path="/ScaryStory-Detailed" element={<ScaryStoryDetailedPage />} />
//           <Route path="/FablesStory-Detailed" element={<FablesStoryDetailedPage />} />
//           <Route path="/Fairytales-Detailed" element={<FairytalesDetailedPage />} />
...
//           <Route path="/SilentCradleVideo" element={<SilentCradelVideoDetailPage />} />
//           <Route path="/ElijahQuestVideo" element={<ElijahQuestVideoDetailPage />} />
//           <Route path="/ContactUs" element={<ContactUsPage />} />
//           <Route path="/SearchPage" element={<SearchPage />} />
//           <Route path="/TravelTipsDetailedPage" element={<TravelTripDetailPage />} />
//           <Route path="/ChasingSunsetsDetailedPage" element={<ChasingSunsetDetailPage />} />
//           <Route path="/HiddenGemsDetailedPage" element={<HiddenGemsDetailPage />} />
//         </Routes>
//       <Footer />
//     </>
//   );
