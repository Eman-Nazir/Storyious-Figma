    ...
    <div className="flex flex-col lg:flex-row lg:gap-16 mx-4 sm:mx-6 lg:mx-14 my-10 lg:my-14">
      ...
      <div className="flex-1 space-y-5">
        ...
        <p className="text-base sm:text-lg leading-relaxed text-justify text-[var(--text-gray)]">
          Agriculture has been the backbThree of human sustenance since the dawn of <br className="hidden sm:block" /> civilization, providing the <span className="text-[var(--pink-dark)] text-lg">vital link</span> between the soil beneath his feet and the nourishment on his plate.
        </p>
...
export default BlogThreeDetailPage;
