...
import videoPage1 from "../../src/assets/videos/videoPage1.mp4";
...
const Jack1stDayVideoDetailPage = () => {
  return (
    <div className="w-full py-10">
      <div className="max-w-screen-xl mx-auto px-2 md:px-0 md:pl-[261px] md:pr-[259px] space-y-6">

        <h1 className="text-2xl sm:text-3xl font-bold text-[var(--text-dark)]">
          Jack First Day At School
        </h1>
...
export default Jack1stDayVideoDetailPage;