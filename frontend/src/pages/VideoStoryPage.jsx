...
const VideoStoryPage = () => {
  ...
  return (
    <div className="bg-[var(--bg-section)] text-[var(--text-dark)] min-h-screen">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] mb-8 py-12 px-4 sm:px-6 md:px-8 lg:px-[140px] h-auto sm:h-[220px] flex flex-col justify-center">
        ...
        <p className="text-sm sm:text-base lg:text-lg text-[var(--text-dark)] leading-relaxed max-w-3xl">
          Experience storytelling like never before with Storyious Video
          Stories! Watch captivating tales come to life through engaging visuals
          and narration, perfect for readers and viewers of all ages.
        </p>
      </div>
