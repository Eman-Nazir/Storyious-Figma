        ...
        <table className="min-w-full border-collapse">
          <thead>
            <tr className="bg-pink-100 text-pink-800 uppercase text-sm">
              ...
              <th className="px-6 py-4 text-left font-semibold">Intro</th>
              <th className="px-6 py-4 text-center font-semibold">Views</th>
              <th className="px-6 py-4 text-center font-semibold">Read Time</th>
            ...
            {blogs.length > 0 ? (
              blogs.map((blog, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-center text-gray-700">{blog.meta?.views || 0}</td>
                  <td className="px-6 py-4 text-center text-gray-700">{blog.meta?.readTime || "N/A"}</td>
                  <td className="px-6 py-4 text-center text-gray-700">{blog.commentsCount || 0}</td>
