...
import videoPage3 from "../../src/assets/videos/videoPage3.mp4";
...
const ElijahQuestVideoDetailPage = () => {
  return (
    <div className="w-full py-10">
      <div className="max-w-screen-xl mx-auto px-4 md:px-0 md:pl-[261px] md:pr-[259px] space-y-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-[var(--text-dark)]">
          Beyond the Palace Walls: Elijah's Quest for True Purpose (Part 1 of 2)          
        </h1>
        ...
        <p className="text-justify leading-relaxed text-[var(--text-gray)]">
          Theoretically, the <span className="text-[var(--pink-dark)] text-lg">"World Food System"</span>...
        </p>
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-[var(--text-dark)] my-2">
        ...
        <p className="text-[var(--text-gray)] text-justify leading-relaxed">
          Experts do not <span className="text-[var(--pink-dark)] text-lg">universally agree</span>...
        </p>
        <p className="text-[var(--text-gray)] text-justify leading-relaxed">
          According to the <span className="text-[var(--pink-dark)] text-lg">ICHD-3</span>...
        </p>
        <p className="text-[var(--text-gray)] text-justify leading-relaxed">
...
export default ElijahQuestVideoDetailPage;
