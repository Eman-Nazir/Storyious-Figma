    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow w-full">
        {loading ? (
          ...
          <div className="flex items-center justify-center h-full min-h-[calc(100vh-128px)] text-red-500">
            {error}
          </div>
        ) : categories.length === 0 ? (
          <div className="flex items-center justify-center h-full min-h-[calc(100vh-128px)]">
          ...
          <div className="flex flex-col w-full">
            {/* Header Section */}
            <div className="bg-gradient-to-r from-[var(--gradient-start)] to-[var(--gradient-end)] py-14">
              <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12">
                ...
                <p className="text-md sm:text-base text-[var(--text-gray)] leading-relaxed text-justify">
                  Discover the full collection of story categories on Storyious! From timeless classics and magical
                  fairytales to thought-provoking moral tales and spine-chilling scary stories, explore a world of
                  storytelling for every mood and reader.
                </p>
              </div>
            </div>
