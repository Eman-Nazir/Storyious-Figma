...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (exploreOpen && !event.target.closest('.explore-container')) {
        setExploreOpen(false);
      }
    };
  ...
  }, [showResults, userDropdownOpen, exploreOpen]);
      ...
      <div className='relative bg-[var(--white)] shadow-sm '>
        <nav className='py-2 max-w-[1200px] mx-auto flex flex-wrap justify-between items-center px-4 md:px-6'>
          ...
          <div className='flex gap-3 items-center'>
            <Loader className='w-5 h-5 animate-spin text-[var(--pink-dark)]' />
          </div>
        </nav>
      </div>
    );
    ...
    <div className='relative bg-[var(--white)] shadow-sm '>
      ...
      <nav className='py-2 max-w-[1200px] mx-auto flex flex-wrap justify-between items-center px-4 md:px-6'>
        <div className='flex items-center gap-3 flex-1 relative'>
          ...
          <div className='relative hidden md:block explore-container'>
            <div
        ...
        <div className='hidden md:flex gap-3 items-center'>
          ...
          {user ? (
            // User Profile Dropdown (for both regular users and admin)
            <div className="relative user-dropdown">
              ...
              {userDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  ...
                  {/* Show My Profile only for regular users, not for admin */}
                  {user.role !== 'admin' && (
                    <Link
                      to="/profile"
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 w-full px-4 py-2 text-sm text-red-600 hover:bg-gray-50 transition border-t border-gray-100 mt-1"
                  >
        ...
        <div className='md:hidden flex gap-4 items-center'>
          {user ? (
            // Mobile User Dropdown (when user is logged in)
            <div className="user-dropdown">
              ...
              {userDropdownOpen && (
                <div className="absolute right-4 top-full mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  <div className="px-4 py-2 border-b border-gray-100">
                    <div className="flex items-center gap-2 mb-1">
                      <p className="font-medium text-sm text-gray-800">
                        {getDisplayName()}
            ...
            // Mobile Sign Up Button (when user is NOT logged in)
            <button
              onClick={() => {
                handleNavigate();
                navigate('/signup');
              }}
              className='bg-[var(--pink-dark)] text-[var(--white)] px-3 py-1 rounded-md text-sm font-medium cursor-pointer'
            >
              Sign Up
            </button>
          )}
        ...
        >
          <div className="px-6 py-3 hidden md:flex items-center justify-between">
            ...
            <X 
              ...
              onClick={handleCloseYellowBanner}
            />
          </div>
        </div>
      )}
                ...
                <div className="border-t border-gray-200 pt-4">
                  ...
                  {user.role !== 'admin' && (
                    <Link
                      ...
                      className="block w-full text-center border border-[var(--pink-dark)] text-[var(--pink-dark)] py-2 rounded-md font-medium mb-2"
                    >
                      My Profile
                    </Link>
                  )}
                  ...
                  {user.role === 'admin' && (
                    <Link
                      to="/admin/dashboard"
                      onClick={handleNavigate}
                      className="block w-full text-center border border-yellow-500 text-yellow-600 py-2 rounded-md font-medium mb-2"
                    >
                      Admin Dashboard
                    </Link>
                  )}
                  ...
                  <button
                    onClick={handleLogout}
                    className="block w-full text-center bg-red-600 text-white py-2 rounded-md font-medium"
                  >
                    Logout
                  </button>
                </div>
      ...
      {exploreOpen && (
        <div 
          className='hidden md:flex fixed left-0 top-[60px] w-screen h-[320px] bg-[var(--white)] shadow-lg z-50 gap-8 px-8 py-6 explore-container'
